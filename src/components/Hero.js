...
const Hero = () => {
    ...
    return (
        <section
            id='home'
            className='relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#f5eed8] via-[#f0e5c8] to-[#e8d9b8]'
        >
            {/* Decorative Elements */}
            ...
            <div className='container mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 relative z-10'>
                <div className='max-w-4xl mx-auto text-center'>
                    {/* Main Title */}
                    <h1 className='font-suez text-5xl sm:text-6xl lg:text-7xl font-bold text-[#58432a] mb-6 animate-fade-in'>
                        {t('heroTitle')}
                    </h1>
                    ...
                    <div className='animate-bounce'>
                        <ChevronDown
                            className='w-8 h-8 text-[#7a5a3a] mx-auto cursor-pointer'
                            onClick={() => scrollToSection('menu')}
                        />
                    </div>
                </div>
