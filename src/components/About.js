...
import { Sparkles, Heart, Store } from 'lucide-react';
...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-[#f5eed8] to-[#f0e5c8]">
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <CardContent className="text-center">
                  <p className="text-[#7a5a3a]">{feature.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
